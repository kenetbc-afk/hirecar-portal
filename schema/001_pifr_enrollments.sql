...
CREATE TABLE IF NOT EXISTS pifr_enrollments (
  ...
  primary_member  TEXT DEFAULT '',
  covered_members TEXT DEFAULT '',
  plan_members    TEXT DEFAULT '',
  ...
  zip             TEXT DEFAULT '',
  notes           TEXT DEFAULT '',
  source_validation_status TEXT DEFAULT '',
  source_validation_matched_by TEXT DEFAULT '',
  source_validation_reason TEXT DEFAULT '',
  source_validation_at TEXT,
  report_access_status TEXT DEFAULT '',
  report_access_details TEXT DEFAULT '',
  score_model TEXT DEFAULT '',
  report_last_updated TEXT,
  equifax_score   INTEGER DEFAULT 0,
  experian_score  INTEGER DEFAULT 0,
  transunion_score INTEGER DEFAULT 0,
  fico_scores     TEXT DEFAULT '',
  fico_auto_score_average INTEGER DEFAULT 0,
  fico_score_8    INTEGER DEFAULT 0,
  fico_real_estate_rental_score INTEGER DEFAULT 0,
  ssn_funding_status TEXT DEFAULT '',
  bnpl_status     TEXT DEFAULT '',
  bnpl_approved_amount INTEGER DEFAULT 0,
  client_review_status TEXT DEFAULT '',
  assigned_to     TEXT,
